...
:information_source: &nbsp;Este repositorio tiene como objetivo recopilar información y recursos útiles sobre DevOps y, en segundo lugar, proporcionar una hoja de ruta para aquellos que quieran practicar DevOps.

:pencil: &nbsp;Siéntete libre de agregar más recursos enviando solicitudes de extracción.
...
Practicar DevOps sin saber programación es como comer cereales con kétchup: simplemente no tiene sentido (sí, mis analogías son pésimas).<br>
...
Aquí tienes una lista de recursos que te ayudarán a aprender Linux.<br>
