...
Esta es una guía paso a paso sobre cómo convertirse en un ingeniero de DevOps, con enlaces a recursos de aprendizaje relevantes que he ido encontrando en la red, espero que os guste y como siempre acompañado con un buen cafe y musica dev.

Si desea obtener más información sobre DevOps, asegúrese de suscribirse a **[mi newsletter](https://newsletter.nvarona.x10.bz/)**. 

## Disclaimer

> El propósito de esta hoja de ruta es darle una idea del panorama. Le servirá de guía si no sabe qué aprender a continuación, en lugar de animarle a elegir lo que está de moda. Debe comprender por qué una herramienta es más adecuada para ciertos casos que otra y recordar que lo que está de moda no siempre significa que sea la más adecuada para el trabajo.

## Give a Star! :star:

Si te gusta este proyecto o lo estás usando para aprender o empezar a usar tu solución, dale una estrella. ¡Gracias!

![DevOps roadmap](DevOps-Roadmap.png)

## PDF version

[![DevOps roadmap](pdfversion.png)](DevOps-Roadmap.pdf)

Download [PDF version](DevOps-Roadmap.pdf).
...
![DevOps roadmap](devops-tools.png)
...
Si crees que la hoja de ruta se puede mejorar, abre una solicitud de registro con las actualizaciones y reporta cualquier problema. Además, seguiré mejorándola, así que te recomendamos que marques este repositorio para volver a visitarlo.

## Contribution

- Abrir una solicitud de incorporación de cambios con mejoras
- Debatir ideas en incidencias
- Correr la voz
...
[![Patreon](patreon.png)](https://nvarona.x10.bz)
...
- [Ing. Natxo Varona](https://nvarona.x10.bz) -  FEO en [Retro Space Labs (2025)](https://nvarona.x10.bz/retro).
- ...
